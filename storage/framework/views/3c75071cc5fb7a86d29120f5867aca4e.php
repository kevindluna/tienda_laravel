...
<head>
    ...
    <!-- Scripts -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/cacharreria.css', 'resources/css/style.css', 'resources/js/app.js']); ?>
...
<body>
    <div id="app">
        <nav class="navbar">
            <a class="brand navbar-brand" href="<?php echo e(url('cacharreria')); ?>">Cacharreria</a>
            <div class="hamburger" onclick="toggleMenu()">☰</div>
            <ul class="nav-links" id="navLinks">
                <li><a href="<?php echo e(url('/')); ?>">Inicio</a></li>

                <li><a href="#" class="active">Cacharreria</a></li>
...
</html><?php /**PATH C:\xampp\htdocs\Tienda-Laravel\resources\views/layouts/appCacharreria.blade.php ENDPATH**/ ?>